...
from app.controllers.client_controller import create_client, search_client_by_name, search__client_by_phone, update_client,delete_client
...
def search_by_phone():
    ...
    client = search__client_by_phone(phone)
    if not client:
        return jsonify({"error": "cliente no faunding"}), 400
